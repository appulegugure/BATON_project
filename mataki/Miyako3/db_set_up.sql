...
CREATE TABLE `community` (
    ...
    `community_maker` varchar(50) NOT NULL,
...
CREATE TABLE `job_order` (
    ...
    `receive_user` varchar(50) DEFAULT NULL,
    ...
    CONSTRAINT `job_order_ibfk_4` FOREIGN KEY (`order_user`) REFERENCES `user` (`email`),
    CONSTRAINT `job_order_ibfk_5` FOREIGN KEY (`receive_user`) REFERENCES `user` (`email`),
    CONSTRAINT `job_order_ibfk_6` FOREIGN KEY (`people_id`) REFERENCES `Number_of_people` (`id`)
...
CREATE TABLE `community_user` (
    ...
    CONSTRAINT `community_user_ibfk_2` FOREIGN KEY (`user`) REFERENCES `user` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
